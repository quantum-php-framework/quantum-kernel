...
if (!function_exists('is_qs'))
{
    /**
     * Check if object is a QString
     *
     * @param  array   $array
     * @param  string  $key
     * @param  mixed   $value
    ...
    function is_qs($object)
    {
        return is_a($object, Quantum\QString::class);
    }
}
...
if (!function_exists('get_request_header'))
{
    ...
    {
        return Quantum\Request::getInstance()->getHeader($key);
    }
}
